...
public class Strings {
    public static void main(String[] args) {
        ...
        System.out.println("Compare to (ignore case): " + normalString.compareToIgnoreCase(charStr));
        ...
        System.out.println("Equals (Ignore case): " + normalString.equalsIgnoreCase(charStr));
        ...
        System.out.println("Check if region of string are equal: " + normalString.regionMatches(0, charStr, 0, 10));
